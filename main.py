...
app.config["SQLALCHEMY_DATABASE_URI"] = f"sqlite:///{app.root_path}/instance/data.db"
app.config["MAIL_SERVER"] = "smtp.gmail.com"
app.config["MAIL_PORT"] = 465
app.config["MAIL_USE_SSL"] = True
app.config["MAIL_USERNAME"] = "khui3850@gmail.com"
...
class Form(db.Model):
    """Creates columns their datatypes inside data.db"""
